...
int xzminidec(/* int argc, char **argv */)
{
	FILE* fpin;
	FILE* fpout;
	struct xz_buf b;
	...
	fpin = fopen("C:/Users/slahane/Documents/Workspace/Renault VK/B32_CC2640R2_P1RenaultVK_Integration_v4.3.0.hex.xz" , "r");
	fpout = fopen("C:/Users/slahane/Documents/Workspace/Renault VK/B32_CC2640R2_P1RenaultVK_Integration_v4.3.0.hex" , "w+");
	...
	while (true) {
		if (b.in_pos == b.in_size) {
			b.in_size = fread(in, 1, sizeof(in), fpin);
			b.in_pos = 0;
		}
		...
		if (b.out_pos == sizeof(out)) {
			if (fwrite(out, 1, b.out_pos, fpout) != b.out_pos) {
				msg = "Write error\n";
				goto error;
			}
